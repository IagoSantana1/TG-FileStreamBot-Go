...
// MediaCopyItem representa uma mídia individual acompanhada de sua legenda/caption
type MediaCopyItem struct {
...
func FileFromMedia(media tg.MessageMediaClass, messageText string) (*types.File, error) {
	...
	case *tg.MessageMediaPhoto:
		...
		return &types.File{
			...
			DisplayName: fmt.Sprintf("photo_%d.jpg", photo.GetID()),
			MimeType:    "image/jpeg",
			ID:          photo.GetID(),
		}, nil
	}
